(function () {
    ...
    Ajax.prototype.PUT = "PUT";
    Ajax.prototype.DELETE = "DELETE";
    ...
    Ajax.prototype.send = function (option) {
        ...
        option.error = option.error || function (e) {
        ...
        if (option.method === 'GET') {
            ...
            this.xhr.open('PUT', option.url, option.async);
            // PUT方法要添加请求头
            this.xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8');
        } else if (option.method === 'DELETE') {
            this.xhr.open('DELETE', option.url, option.async);
            // POST方法要添加请求头
            this.xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded;charset=utf-8');
        }
